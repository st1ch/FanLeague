...
@Module public class ActivityModule {
  ...
  @Provides @PerActivity DialogHelper provideDialogHelper(AppCompatActivity activity,
      DateUtils dateUtils, FanUtils fanUtils, ImageLoaderHelper imageLoaderHelper) {
    return new DialogHelper(activity, dateUtils, fanUtils, imageLoaderHelper);
  }
}
