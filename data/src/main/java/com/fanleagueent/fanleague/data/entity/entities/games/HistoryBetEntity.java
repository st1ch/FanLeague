...
public class HistoryBetEntity {
  ...
  public void setPlayHistoryTypeDataEntity(PlayHistoryTypeDataEntity playHistoryTypeDataEntity) {
    this.playHistoryTypeDataEntity = playHistoryTypeDataEntity;
  }
  ...
  @Override public String toString() {
    return "HistoryBetEntity{" +
        ...
        ", weekLabel='" + weekLabel + '\'' +
        ", isTeam=" + isTeam +
        ", playHistoryTypeDataEntity=" + playHistoryTypeDataEntity +
        '}';
  }
}
