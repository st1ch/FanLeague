...
public class LeagueEntity implements Comparable<LeagueEntity> {
    @SerializedName("_id")
    private String id;
    ...
    @SerializedName("is_current_user_owner")
    private boolean isCurrentUserOwner;

    @SerializedName("average_winning_bets")
    private float averageWinningBets;

    @SerializedName("average_winning_money_amount")
    ...
    @Override
    public int compareTo(@NonNull LeagueEntity leagueEntity) {
        return id.compareTo(leagueEntity.getId());
    }
}
